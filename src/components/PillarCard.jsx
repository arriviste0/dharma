...
import {
  ChevronDown, ChevronUp, Plus, Check, Edit3,
...
export default function PillarCard({ pillar, logs, onLog, defaultExpanded = false }) {
  ...
  return (
    <div className="card transition-all duration-200" style={{ borderLeft: `3px solid ${pillar.color}` }}>
