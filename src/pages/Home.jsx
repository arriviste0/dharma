...
import { Settings, Sparkles, Timer, Target, Edit3 } from 'lucide-react';
  ...
  return (
    <div className="card mb-4">
      ...
      <div className="flex gap-1.5 justify-between">
        {days.map(({ key, label, rate, isToday }) => {
          const bg =
            rate >= 0.8 ? '#C9A961' :
            rate >= 0.5 ? '#E8843C' :
            rate > 0    ? '#5A8A8A' :
...
export default function Home() {
  const { state, logTarget, toggleBookmark, setIntention, logFocusSession } = useStorage();
    ...
    <div className="page-container page-transition">
      ...
      {showTimer  && (
        <FocusTimer
          ...
          onComplete={(session) => logFocusSession(session)}
        />
      )}
        ...
        <div className="lg:col-span-3">
          ...
          {dailyDialogue && (
            <div className="card mb-4" style={{ borderLeft: '3px solid #E8843C' }}>
              <p className="section-label mb-3">Arjuna asks · Krishna answers</p>
